...
## 2026-07-23 — NC-003B Phase 0 corrective source-normalization integration

- Timestamp: 2026-07-23 (Europe/Warsaw)
- User request: Preserve the rejected forensic checkout, continue the clean-room NC-003B Phase 0 source-normalization integration, verify artifact-only traces through a temporary Windows junction, and publish a separate draft integration PR without accepting Phase 0.
- Baseline branch and commit: `manager/nc-003b-phase0-reconstruction` at `3c67a53a1c2a8d940736e21218cfd89a0b9870b6`; baseline tree `64a4af00ed06bdaa57553960685e670a472b55ba`.
- Repository history reviewed: Existing append-only manager history and repository execution policy were read in the clean-room checkout. Inputs were verified as B `baff818ad6cce157dbcd94088d74f4a2c22c16fb` / tree `22c8ffe428b96b60c0bc401bbc3ff22bdddf97f5` / PR #40, and G `ab70fb2b0227e4274387357145e734d7d2fde29a` / tree `6b4a9479ba764754ea4f59cc11fb3fe6cae981c9` / PR #41.
- Repository state found: Clean-room merge `8548a70387aa36d9b567652eee4cd0f1319d527a` / tree `69f3faa5d1b82dddab1d9985ab8da0b9fae1cddc` has parents B then G and source scope `8M/13D/21`. Only the profile, generated header, and source manifest metadata were modified before this append.
- Workstream decomposition and programmer-agent assignments: This was a tightly coupled clean-room reconciliation and validation operation; no programmer-agent workstream was assigned. The rejected checkout remained forensic-only and was not modified.
- Files and behavior changed: Reconciled only `subaru_ej25_cold_start_profile.json`, `SubaruEJ25ColdStartProfile.generated.h`, and `SOURCE_MANIFEST.json`, then appended this history record. Generator SHA is `6efb3d29734c2d41c96d16e914ab460cd212769d611ba08cf2677377d933659d`; verifier SHA is `92b4ebdb922b409cf8c583fc7c7d7cb56a16dd70606c2080673ef6dc77e7d57d`; payload SHA is `093ef4e39526563ebcc211e127a7556dda0a154e1f4b0e75c806edf360389f1d`; generated header SHA is `da5a00fa9d776408f9f01d7f01be62e4ccd744368d07036eb0eefcc5373ac20e`.
- Evidence and exact tests: Artifact provenance P1 — EXACT: source run `29814599329`, artifact ID `8488882253`, ZIP SHA-256 `f7b9004e24a81f1558c1df39a7d27dd31a9cc0a916a46f00e6f4b10881b1727b`; 40/40 hash-manifest entries passed and 12/12 trace hashes and JSON parses passed. A temporary Windows junction mounted the artifact-only traces; it was removed before this entry and 0 trace files are committed. `verify_cold_start_profile.py` passed with generator/verifier/payload/header hashes, 10 positives, timeout, stall, and generator determinism; unittest discovery passed 57 tests; calibration `self-test` passed; fixture snapshot passed; Subaru fixture verifier passed 118/118.
- Decisions and integration notes: `UNREAL_GATE_DECISION=B`. No Unreal gate was run. Phase 0 remains not accepted; Phase 1 remains not started; final Windows exact-head validation is not run.
- Unresolved risks or blockers: CMake/CTest is deferred unless the required standalone toolchain is available; final Windows exact-head validation remains an explicit later gate.
- Next steps: Complete clean-room final static validation, scope review, metadata-only commit, non-force push, and a draft PR targeting `manager/nc-003b-phase0-reconstruction`.
