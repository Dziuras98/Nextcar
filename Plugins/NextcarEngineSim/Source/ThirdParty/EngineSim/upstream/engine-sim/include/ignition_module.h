...
class IgnitionModule : public Part {
    ...
    public:
        ...
        double getLimiterDuration() const { return m_limiterDuration; }
        double getFiringOrder(int index) const { return m_plugs[index].angle; }
        Function *getTimingCurve() const { return m_timingCurve; }
